...
namespace Like.Model.JWT
{
    public class JWTPolicyHandler : AuthorizationHandler<JwtPolicyRequirement>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, JwtPolicyRequirement requirement)
        {
            //赋值用户权限
