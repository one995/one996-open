...
namespace Like.Expand
{
    public static class SqlsugarSetup
    {
        ...
        public static void AddSqlsugarSetup(this IServiceCollection services)
        {
            ...
            sqlSugar.CodeFirst.InitTables(typeof(Model.Models.HomeSet));
            sqlSugar.CodeFirst.InitTables(typeof(Model.Models.ComputerInfo));
            sqlSugar.CodeFirst.InitTables(typeof(Model.Models.ComputerUserInfo));
